...
## 1. **Завдання 2: Проектування баз даних з використанням семантичних моделей**
...
Цей проєкт включає власну **SQL IDE - GOD MODE PRO**, розроблену для зручного виконання завдань без необхідності використовувати важкі десктопні клієнти типу MySQL Workbench.
...
4. У терміналі (в корені проєкту) виконайте команду:
...
- `make clean` — **Hard Reset**: жорстко видаляє всі згенеровані бази даних, контейнери, мережу та `.venv`, повертаючи проєкт до абсолютно чистого стану.
